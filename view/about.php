    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="text">
                    <h2>About Us</h2>
                    <p>RK Riyasat Resorts is one of the biggest spot for wedding , parties, rooms , restaurants etc.</p>
                </div>
            </div>
            <!-- About Item End -->
        </div>
...
<div class="hotel-service-2">
    <div class="container">
        <div class="main-title">
            ...
            <p>In North India we are the biggest and best place for weddings , corporate functions , Rooms and Restaurant. Our hospitality proves the top class in operations and service</p>
        </div>
                ...
                <div class="item active">
                    <div class="container">
                        <div class="col-md-8 col-md-offset-2 testimonials-inner">
                            ...
                            <p>
                                <em>"</em>
                                They mean what they say. They absolutely deliver as promised. Rk Riyasat is special as I celebrated my wedding reception at this very place. Lighting to Food to Music to Ambience... it was Beautiful. You tell them what you need and they'll do ALL and MORE to accommodate and give you the perfect setting for your occasion.
                                <em>"</em>
                            </p>
                            <!-- Author Rate -->
                            <div class="author-rate">
                                <img src="img/profile.png" alt="profile-01">
                                <h4>Rajesh Kumar</h4>
                                <span>Customer</span>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="container">
                        <div class="col-md-12 col-md-8 col-md-offset-2 testimonials-inner">
                            ...
                            <p>
                                <em>"</em>
                                A fantastic place in Nagpur for wedding, any other party and Special occasions!The team handles everything with ease and are awesome at what they do! Surely recommend it to all.
                                <em>"</em>
                            </p>
                            <!-- Author Rate -->
                            <div class="author-rate">
                                <img src="img/profile.png" alt="profile-02">
                ...
                <div class="item">
                    <div class="container">
                        <div class="col-md-12 col-md-8 col-md-offset-2 testimonials-inner">
                            ...
                            <p>
                                <em>"</em>
                                A fantastic place to celebrate Special occasions! The team handles everything with ease and are awesome at what they do! Surely recommend it to all
                                <em>"</em>
                            </p>
                            <!-- Author Rate -->
                            <div class="author-rate">
                                <img src="img/profile.png" alt="profile-03">
                                <h4>Rahul Agarwal</h4>
                                <span>Customer</span>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="container">
                        <div class="col-md-12 col-md-8 col-md-offset-2 testimonials-inner">
                            ...
                            <p>
                                <em>"</em>
                                ...because of you, our wedding looked and went fantastic. The food was absolutely amazing. It tasted like Thanksgiving dinner. We had so many compliments from everyone that the place was beautiful. Thank you again and we can't tell you enough how wonderful your building and service was. We will, and have recommended you to others!!
                                <em>"</em>
                            </p>
                            <!-- Author Rate -->
                            <div class="author-rate">
                                <img src="img/profile.png" alt="profile-04">
                                <h4>Amit Gupta</h4>
                                <span>Customer</span>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 footer-item clearfix">
                <div class="footer-item-content">
                    ...
                    <div class="clearfix"></div>
                    <!-- paragraph-->
                    <p>Just 7 km From Pipli Towards Karnal,NH-1,Samana,Opp. Shakti Bhog Mill
Samana, India</p>
